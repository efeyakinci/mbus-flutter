      ...
      case SUBMISSION_STATES.PRE_SUBMIT:
        return AnimatedOpacity(
          ...
          child: CupertinoButton(
            color: MICHIGAN_BLUE,
            onPressed: feedback.isNotEmpty ? onSubmit : () {},
            child: Text("Submit", style: AppTextStyles.buttonPrimary),
          ),
        );
      ...
      case SUBMISSION_STATES.SUCCESS:
        return Row(
          children: [
            ...
            Flexible(
                child: Text("Your feedback has been successfuly submitted."))
          ],
        );
          ...
          children: [
            ...
            Flexible(
                child: SelectableText(
                    "Error while submitting the feedback. Please feel free to email the feedback through my contact info on efeakinci.com/mbus"))
          ],
        );
      case SUBMISSION_STATES.TOO_MANY_REQUESTS:
        return Row(
          children: [
            ...
            Flexible(
                child: SelectableText(
                    "There have been too many requests from your current network. Please try again later."))
          ],
        );
    }
  }
